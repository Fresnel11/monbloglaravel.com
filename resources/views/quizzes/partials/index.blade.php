...
<div id="container" class="card1">
    ...
    <form id="form" action="{{ route('quiz.submit') }}" method="POST">
        ...
        <div class="cardss">
            <div class="card red">
                <p class="tip">{{ $question->question }}</p>
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="question_{{ $question->id }}" value="true" id="question_{{ $question->id }}_true">
                    <label class="form-check-label" for="question_{{ $question->id }}_true">
                        Vrai
                    </label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="question_{{ $question->id }}" value="false" id="question_{{ $question->id }}_false">
